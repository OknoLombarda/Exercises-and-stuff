...
[**Find PI to the Nth Digit**](https://github.com/OknoLombarda/Exercises-and-stuff/blob/master/Martyr2's%20projects/Files/me/math/pi/FindPI.java) – Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.
...
[**Sieve of Eratosthenes**](https://github.com/OknoLombarda/Exercises-and-stuff/blob/master/Martyr2's%20projects/Files/SieveOfEratosthenes.java) - The sieve of Eratosthenes is one of the most efficient ways to find all of the smaller primes (below 10 million or so).

Graphs
---------

[**Graph from links**](https://github.com/OknoLombarda/Exercises-and-stuff/blob/master/Martyr2's%20projects/Files/me/graphs/GraphFromLinks.java) - Create a program that will create a graph or network from a series of links.
...
[**Product Inventory Project**](https://github.com/OknoLombarda/Exercises-and-stuff/tree/master/Martyr2's%20projects/Files/me/inventory) – Create an application which manages an inventory of products. Create a product class which has a price, id, and quantity on hand. Then create an inventory class which keeps track of various products and can sum up the inventory value.
